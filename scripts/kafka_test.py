...
def create_consumer(topic: str, bootstrap_servers: str = 'localhost:29092', group_id: str = 'test-group'):
...
def main():
    ...
    producer_parser.add_argument('--bootstrap-servers', default='localhost:29092', help='Kafka bootstrap servers')
    producer_parser.add_argument('--topic', default='test-topic', help='Topic to produce messages to')
    producer_parser.add_argument('--num-messages', type=int, default=5, help='Number of messages to produce')
    
    # Consumer command
    consumer_parser = subparsers.add_parser('consume', help='Consume messages from Kafka')
    consumer_parser.add_argument('--bootstrap-servers', default='localhost:29092', help='Kafka bootstrap servers')
    consumer_parser.add_argument('--topic', default='test-topic', help='Topic to consume messages from')
    consumer_parser.add_argument('--group-id', default='test-group', help='Consumer group ID')
    consumer_parser.add_argument('--num-messages', type=int, default=5, help='Maximum number of messages to consume')
    consumer_parser.add_argument('--timeout', type=int, default=30, help='Timeout in seconds')
